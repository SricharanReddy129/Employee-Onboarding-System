...
@router.post("/", response_model=DesignationResponse, dependencies=[Depends(require_roles("HR", "ADMIN", "REPORTING_MANAGER","GENERAL"))])
...
@router.get("/", response_model=List[DesignationResponse], dependencies=[Depends(require_roles("HR", "ADMIN","REPORTING_MANAGER","GENERAL"))])
...
@router.get("/department/{department_uuid}",dependencies=[Depends(require_roles("HR", "ADMIN","REPORTING_MANAGER","GENERAL"))])
...
@router.get("/{designation_uuid}",dependencies=[Depends(require_roles("HR", "ADMIN","REPORTING_MANAGER","GENERAL"))])
...
@router.put("/{designation_uuid}", response_model=DesignationResponse, dependencies=[Depends(require_roles("HR", "ADMIN", "REPORTING_MANAGER","GENERAL"))])
...
@router.delete("/{designation_uuid}", dependencies=[Depends(require_roles("HR", "ADMIN", "REPORTING_MANAGER","GENERAL"))])
