...
@router.post("/", response_model=DepartmentResponse, dependencies=[Depends(require_roles("HR", "ADMIN","REPORTING_MANAGER"))])
...
@staticmethod
@router.get("/", response_model=List[DepartmentResponse],dependencies=[Depends(require_roles("HR", "ADMIN","REPORTING_MANAGER","GENERAL"))])
...
@router.get("/{department_uuid}", response_model=DepartmentResponse, dependencies=[Depends(require_roles("HR", "ADMIN","REPORTING_MANAGER","GENERAL"))])
...
@router.delete("/{department_uuid}", dependencies=[Depends(require_roles("HR", "ADMIN", "REPORTING_MANAGER","GENERAL"))])
